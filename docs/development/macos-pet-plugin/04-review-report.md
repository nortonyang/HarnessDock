...
- 核心契约：`Sources/DsHarnessCore/PetPlugin.swift`。
- macOS 运行时与 UI：`PetPluginController.swift`、`PetPluginView.swift`、`ContentView.swift`、`DsHarnessApp.swift`。
...
- 内置资源：源图集与 `dist/DsHarness.app/Contents/Resources/Pets/DeepWhale/spritesheet.webp` SHA-256 均为 `ebc6e64d252a957cd4bfe1573baa6fbc61310f5142c3e9b1269141049735151e`。
